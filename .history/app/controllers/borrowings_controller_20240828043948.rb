class BorrowingsController < ApplicationController
  ...
  # PATCH/PUT /books/:book_id/borrowings/:id/return
  # PATCH/PUT /books/:book_id/borrowings/:id/return.json
  api :PATCH, '/books/:book_id/borrowings/:id/return', 'Mark a borrowing as returned'
