class BooksController < ApplicationController
  ...
  param :query, String, desc: 'Search query to filter books', required: false
  example 'GET /books'
  example 'GET /books?page=2'
  example 'GET /books?query=Harry Potter'
  def index
  ...
  # GET /books/:id
  # GET /books/:id.json
  api :GET, '/books/:id', 'Get details of a specific book'
  param :id, :number, desc: 'ID of the book to retrieve', required: true
  example 'GET /books/1'
  def show
  ...
  param :genre, String, desc: 'Genre of the book', required: true
  param :isbn, String, desc: 'ISBN of the book', required: true
  param :total_copies, :number, desc: 'Total copies of the book', required: true
  example 'POST /books', {
    title: 'New Book',
    author: 'New Author',
    genre: 'New Genre',
  ...
  api :PATCH, '/books/:id', 'Update a specific book'
  param :id, :number, desc: 'ID of the book to update', required: true
  ...
  param :isbn, String, desc: 'ISBN of the book', required: false
  param :total_copies, :number, desc: 'Total copies of the book', required: false
  def update
    respond_to do |format|
  ...
  api :DELETE, '/books/:id', 'Delete a specific book'
  param :id, :number, desc: 'ID of the book to delete', required: true
  def destroy
    @book.destroy!
